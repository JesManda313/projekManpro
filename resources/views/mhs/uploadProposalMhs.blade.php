        ...
        <div class="mb-10 overflow-x-auto">
            ...
            <div class="flex items-center min-w-max">
                ...
                <div class="flex flex-col items-center flex-shrink-0">
                    ...
                    <p class="mt-2 text-xs sm:text-sm font-semibold text-gray-800">Proposal</p>
                </div>
                ...
                <div class="flex flex-col items-center flex-shrink-0">
                    <div class="w-8 h-8 bg-white border-2 border-gray-300 rounded-full z-10"></div>
                    <p class="mt-2 text-xs sm:text-sm text-gray-500">Skripsi</p>
                </div>
                <div class="flex-auto border-t-2 border-gray-300 mx-2"></div>
                <div class="flex flex-col items-center flex-shrink-0">
                    <div class="w-8 h-8 bg-white border-2 border-gray-300 rounded-full z-10"></div>
        ...
        <form action="action_url" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-6 max-w-3xl mx-auto pt-8">
                <div class="flex items-start space-x-4">
                    <label for="jurusan" class="w-32 text-sm font-medium text-gray-700 pt-2.5">Rincian Proposal</label>
                    <textarea id="jurusan" name="jurusan" rows="3"
                ...
                <div class="flex items-center space-x-4">
                    <label for="file_input" class="w-32 text-sm font-medium text-gray-700">Submit Proposal</label>
