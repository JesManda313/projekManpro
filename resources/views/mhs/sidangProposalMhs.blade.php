...
@section('content1')
    ...
    <style>
        @media (max-width: 767px) {
            #desktop-content-container { /* Ganti ID Desktop */
    ...
    <div class="bg-white bg-opacity-90 backdrop-blur-sm p-4 md:p-8 rounded-xl shadow-lg">
        ...
        {{-- Ganti ID Desktop --}}
        <div class="mb-8 sm:mb-10 overflow-x-auto hidden md:block" id="desktop-content-container">
            ...
            <div class="pt-4 md:pt-8 mb-16 md:mb-20">
                ...
                <div class="flex flex-col items-center justify-center p-0 md:p-4">
                    ...
                    <h1 class="text-2xl md:text-4xl font-semibold text-gray-800 mb-8 md:mb-10 text-center">Jadwal Sidang
                        Proposal</h1>
                    ...
                    <div class="w-full max-w-sm sm:max-w-lg bg-gray-100 p-6 md:p-10 rounded-lg shadow-xl relative">
                        ...
                        <div class="mt-6 md:mt-8 pt-3 md:pt-4 border-t border-gray-300 text-center">
                            <span
                                class="block w-full py-2 text-lg md:text-xl text-white font-medium rounded-lg shadow-lg bg-green-600">
                                {{ $statusSidang }}
                            </span>
                        </div>
        ...
        <div class="mb-8 sm:mb-10" id="mobile-accordion-container" style="display: none;">
            <h3 class="font-medium text-gray-600 mb-4 text-sm sm:text-base">Your Progress</h3>
                ...
                @foreach($steps as $index => $step)
                    <div class="border-b border-gray-200 last:border-b-0">
                        <button type="button"
                            ...
                            <div class="flex items-center">
                                ...
                                @elseif($index == $currentStepIndex)
                                    ...
                                    <div
                                        class="w-4 h-4 mr-3 border-2 border-black rounded-full flex items-center justify-center flex-shrink-0">
                            ...
                            <svg class="w-4 h-4 transform transition-transform duration-300 accordion-icon {{ $index == $currentStepIndex ? 'rotate-180' : '' }}"
                        ...
                        <div id="accordion-body-{{ $index }}"
                            class="overflow-hidden transition-all duration-300 accordion-content"
                            ...
                            <div class="pb-3 pt-1 text-gray-600 text-sm">
                                ...
                                @if($index == $currentStepIndex)
                                    {{-- 
                                    KONTEN UTAMA SIDANG PROPOSAL DI SINI (MOBILE - SUDAH DISAMAKAN) 
                                    --}}
                                    <div class="my-4"> {{-- Margin atas bawah --}}
                                        <h4 class="text-xl font-semibold text-gray-800 text-center mb-6">Jadwal Sidang Proposal</h4>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const desktopContainer = document.getElementById('desktop-content-container'); // Ganti ID Desktop
            ...
            function handleAccordionClick() {
                ...
                if (isExpanded) {
                    ...
                    if (icon) icon.classList.remove('rotate-180'); // Tambah cek jika icon ada
                } else {
                    // Beri nilai max-height yang cukup besar
                    targetElement.style.maxHeight = '800px'; // Coba nilai tetap yang besar
                    targetElement.style.padding = '10px';
                    button.setAttribute('aria-expanded', 'true');
                    if (icon) icon.classList.add('rotate-180'); // Tambah cek jika icon ada
                }
            }
        });
    </script>
