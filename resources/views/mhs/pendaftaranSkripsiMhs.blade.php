...
@section('content1')
    ...
    <div class="bg-white bg-opacity-90 backdrop-blur-sm p-6 sm:p-8 rounded-xl shadow-lg max-w-7xl mx-auto">
        ...
        @php
            ...
            $currentStepIndex = 5; // Tahap aktif: 'Upload Skripsi'
            ...
            <form action="action_url" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6 max-w-3xl mx-auto pt-8">
                    <div class="flex items-start space-x-4">
                        <label for="rincian-skripsi-desktop" class="w-32 text-sm font-medium text-gray-700 pt-2.5">Rincian Skripsi</label>
                        <textarea id="rincian-skripsi-desktop" name="rincian_skripsi" rows="3"
                    ...
                    <div class="flex items-center space-x-4">
                        <label for="file_input_desktop" class="w-32 text-sm font-medium text-gray-700">Submit Skripsi</label>
                                    ...
                                    <form action="action_url" method="POST" enctype="multipart/form-data" class="mt-4">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="flex flex-col space-y-2">
                                                <label for="rincian-skripsi-mobile" class="text-sm font-medium text-gray-700">Rincian Skripsi</label>
                                                <textarea id="rincian-skripsi-mobile" name="rincian_skripsi" rows="3"
                                                    class="bg-gray-50 border border-gray-300 text-sm rounded-lg p-2.5 w-full"
                                                    placeholder="latar belakang, perumusan masalah, tujuan, ruang lingkup, teori"></textarea>
                                            </div>

                                            <div class="flex flex-col space-y-2">
                                                <label for="file_input_mobile" class="text-sm font-medium text-gray-700">Submit Skripsi</label>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function handleAccordionClick() {
            ...
            if (isExpanded) {
                ...
                // Nilai disesuaikan untuk menampung Form dan Tabel Riwayat yang panjang
                // Di sini Anda mungkin perlu meningkatkan nilai untuk menampung semua konten
